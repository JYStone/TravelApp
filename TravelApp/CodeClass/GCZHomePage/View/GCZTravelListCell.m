...
@implementation GCZTravelListCell
...
- (UIImageView *)setCellImageView {
    UIImageView *backImageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 10, kWidth - 20, kWidth * 0.6)];
...
- (UILabel *)setCellLabel {
    UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, kWidth - 30, 30)];
    textLabel.textColor = [UIColor whiteColor];
